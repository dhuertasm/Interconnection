...
public class Modelo {
	...
	private void conectarConPais(Landing landing, String countryName) {
		...
		if (country != null) {
			float weight = distancia(country.getLongitude(), country.getLatitude(), landing.getLongitude(),
					landing.getLatitude());
	...
	private void conectarLandings(Landing landing1, Landing landing2, String cableId) {
		if (landing1 != null && landing2 != null) {
			...
			float weight = distancia(landing1.getLongitude(), landing1.getLatitude(), landing2.getLongitude(),
